...
\begin{frame}{K-means - Disadvantages}
    ...
    \begin{itemize}\small
        ...
        \item \textbf{Assumes convexity}: poorly handles non-convex clusters.
    \end{itemize}
    \end{alertblock}
...
\begin{frame}{DBSCAN - Goal}
  \begin{block}{Objective}
    \centering\normalsize
    Partition points into clusters of \textbf{arbitrary shape} by grouping all points that are \emph{density-reachable} from at least one core point (i.e.\ have $\geq \mathit{minPts}$ neighbours within radius $\varepsilon$), while labelling all remaining points as \textbf{noise}.  \url{https://www.naftaliharris.com/blog/visualizing-dbscan-clustering/}
  \end{block}
\end{frame}
